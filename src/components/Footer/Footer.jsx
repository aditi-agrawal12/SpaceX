    ...
    <div className="bg-sky-900 ">
      <section className="max-w-[1200px] mx-auto text-white">
          ...
          <div className=" py-4 px-4 ">
            ...
            <div className="flex items-center h-10 gap-2">
              <input
                ...
                placeholder="Email"
              />
              <button className="bg-orange-500 hover:bg-orange-600 h-full inline-block py-2 px-6 text-white">
                Ok
              </button>
            </div>
          </div>
        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center text-center py-2 border-t-2 border-gray-300/40">
